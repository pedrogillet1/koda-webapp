// Final approach: Use PyMuPDF (via Python) to extract pages as images, then Mistral OCR
...
`;
    ...
    console.log(`🔄 Processing first ${Math.min(3, numPages)} pages with Mistral OCR...\n`);
