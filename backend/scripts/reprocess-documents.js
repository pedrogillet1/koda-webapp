/**
 * Reprocess Documents Script (JavaScript version)
 * 
 * This script reprocesses documents that have no extracted text.
 * Usage: node scripts/reprocess-documents.js [userId]
 */
...
async function reprocessDocuments(userId) {
  try {
    ...
    const { regenerateEmbeddings } = require('../dist/services/document.service');
