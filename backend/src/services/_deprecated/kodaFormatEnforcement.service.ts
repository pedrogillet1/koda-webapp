...
export class KodaFormatEnforcementService {
  ...
  enforceFormat(
    ...
    // ═══════════════════════════════════════════════════════════════════════════
    // TITLE POST-PROCESSING DISABLED - ChatGPT-style LLM generation
    // Titles are now generated by the LLM via KODA_TITLE_GENERATION_RULES
    // Steps 2-4 (title enforcement, intro validation, section structure) skipped
    // ═══════════════════════════════════════════════════════════════════════════
    console.log(`[KODA FORMAT] Title post-processing DISABLED (LLM generates titles)`);
    console.log(`[KODA FORMAT] Title decision for analytics: ${titleDecision}`);
